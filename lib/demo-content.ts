...
export const demoContent: Record<string, ContentCard[]> = {
  cholesterol: [
    {
      icon: 'heart',
...
export const demoAppointmentDates: Record<string, string> = {
...
/** Maps demo tokens to condition types */
export const TOKEN_MAP: Record<string, string> = {
  cholesterol: 'cholesterol',
  diabetes: 'diabetes',
  hypertension: 'hypertension',
  'patient-a': 'cholesterol',
  'patient-b': 'diabetes',
  'patient-c': 'hypertension',
  'patient-d': 'cholesterol',
  'patient-e': 'hypertension',
  'patient-f': 'diabetes',
}
