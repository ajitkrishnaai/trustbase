    ...
    <div className="min-h-screen bg-[var(--warm-bg)] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[var(--dark-slate)] mb-2">Create your account</h1>
          <p className="text-[var(--slate-secondary)]">Start building trust with your patients</p>
        </div>
        ...
        <div className="bg-[var(--card-bg)] rounded-2xl p-8 shadow-[var(--shadow-medium)] border border-[var(--border-subtle)]">
          ...
          <p className="mt-6 text-center text-sm text-[var(--slate-secondary)]">
            ...
            <Link href="/login" className="text-[var(--teal-primary)] font-medium hover:text-[var(--teal-hover)]">
              Log in
            </Link>
          </p>
        </div>
